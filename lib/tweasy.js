...
Client.prototype.userProfile = function(params, cb) {
  this.request(api_url + "/1/users/show.json", params, cb);
}

Client.prototype.userTimeline = function(params, cb) {
  this.request(api_url + "/1/statuses/user_timeline.json", params, cb);
}

Client.prototype.undo = function(params, cb) {
  return this.request(api_url + "/1/statuses/user_timeline.json", params, cb);
}

Client.prototype.homeTimeline = function(params, cb) {
  this.request(api_url + "/1/statuses/home_timeline.json", params, cb);
}

Client.prototype.directSend = function(params, cb) {
  this.request(api_url + "/1/direct_messages/new.json", params, {method: "POST"}, cb);
}

Client.prototype.retweet = function(id, cb) {
  this.request(api_url + "/1/statuses/retweet/"+id+".json", {},
    {method:"POST"}, cb);
}

Client.prototype.destroy = function(id, cb) {
  this.request(api_url + "/1/statuses/destroy/"+id+".json", {},
    {method:"POST"}, cb);
};

Client.prototype.show = function(id, cb) {
  this.request(api_url + "/1/statuses/show/"+id+".json", {}, cb);
};

//SMS-based notifications
Client.prototype.notificationsOn = function(params, cb) {
  this.request(api_url + "/1/notifications/follow.json", params, {method:"POST"}, cb);
};

Client.prototype.notificationsOff = function(params, cb) {
  this.request(api_url + "/1/notifications/leave.json", params, {method:"POST"}, cb);
};

Client.prototype.block = function(params, cb) {
    this.request(api_url + "/1/blocks/create.json", params, {method:"POST"}, cb);
};

Client.prototype.unblock = function(params, cb) {
    this.request(api_url + "/1/blocks/destroy.json", params, {method:"POST"}, cb);
};
...
Client.prototype.updateStatus = function(status /*, params, cb */) {
  ...
  this.request(api_url + "/1/statuses/update.json", params, {
    rate_limit : false,
    method:"POST"}, cb);
}
